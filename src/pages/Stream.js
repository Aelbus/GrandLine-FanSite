    ...
    const fetchStreamerData = async () => {
      try {
        ...
        const streamerDataList = [
          ...
          {
            username: "anaisMRN",
            nomRP: { Pentacle: "Zoe BAKER", RedDeadRP: "Billie HARPER" },
            arcs: ["Pentacle", "RedDeadRP"],
          },
          {
            username: "kiishar",
          ...
          {
            username: "frenchdee",
            nomRP: { Pentacle: "Gary JAY", RedDeadRP: "" },
            arcs: ["Pentacle", "RedDeadRP"],
          },
          {
            username: "nacked",
          ...
          },
          {
            ...
            nomRP: { Pentacle: "Charlie DAVIS", RedDeadRP: "" },
            arcs: ["Pentacle", "RedDeadRP"],
          },
          {
          ...
          {
            username: "MeikhaTV",
            nomRP: { Pentacle: "Diane KINGSTON", RedDeadRP: "" },
            arcs: ["Pentacle", "RedDeadRP"],
          },
          {
            username: "Matsuki_R",
            nomRP: { Pentacle: "Mile KINGSTON", RedDeadRP: "" },
            arcs: ["Pentacle", "RedDeadRP"],
          },
          {
            username: "Medouda",
          ...
          {
            username: "miisterkel",
            nomRP: { FortCarson: "Michael HAWK", RedDeadRP: "Michael HAWK" },
            arcs: ["FortCarson", "RedDeadRP"],
          },
          {
            username: "PlumeLIVE",
